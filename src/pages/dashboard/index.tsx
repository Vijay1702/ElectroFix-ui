  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f8fafc] to-[#f1f5f9] dark:from-[#020617] dark:to-[#0f172a] p-4 lg:p-6 lg:px-6 space-y-6 animate-in fade-in duration-700">
      ...
      <div className={cn("grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 transition-opacity duration-300", refreshing && "opacity-50")}>
        {[
          { label: "Active Repairs", value: summary?.activeRepairs, detail: "Tasks in progress", icon: Wrench, classes: { glow: "bg-blue-500", bg: "bg-blue-500/10", border: "border-blue-500/20", text: "text-blue-500", badgeText: "text-blue-600 dark:text-blue-400" } },
          { label: "Not Started Queue", value: summary?.notStartedRepairs, detail: "Awaiting start", icon: Activity, classes: { glow: "bg-amber-500", bg: "bg-amber-500/10", border: "border-amber-500/20", text: "text-amber-500", badgeText: "text-amber-600 dark:text-amber-400" } },
